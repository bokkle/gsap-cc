...
const GsapScrollTrigger = () => {
  ...
  useGSAP(
    () => {
      ...
      boxes.forEach((box) => {
        gsap.to(box, {
          ...
          scrollTrigger: {
            trigger: box,
            //start: when bottom of box hits bottom of viewport
            start: "bottom bottom",
            //end: when top of box hits 20% of viewport
            end: "top 20%",
            //scrub: makes animation smooth
            scrub: true,
          },
          ease: "power1.inOut",
        });
    ...
    //exactly when the animation has to happen
    { scope: scrollRef }
  );
